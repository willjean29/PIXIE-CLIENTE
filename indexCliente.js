...
app.engine('hbs',exphbs({
  ...
  helpers: {
    ...
    paginate: function(pagination, options) {
      ...
      var parmPuntos = Number(pagination.parmPuntos);
      var limit;
      ...
      switch (type) {
        ...
        case 'previous':
          if (page === 1) {
            ...
            newContext = { n: page - 1, parmPuntos}
          }
          ret = ret + options.fn(newContext);
          break;
        case 'next':
        ...
        case 'last':
          if (page === pageCount) {
            ...
            newContext = { n: pageCount, parmPuntos }
          }
          ret = ret + options.fn(newContext);
          break;
      }
